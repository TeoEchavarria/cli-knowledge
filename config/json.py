yagami = [
      {
        ...
        "subcommands": [
          ...
          },
          {
            ...
            "attributes": [
              {"name": "title", "alias":"t", "type": str, "required": True, "description": "Title of the task"},
              {"name": "category", "alias":"c", "type": str, "required": False, "description": "Category associated with the task"},
              {"name": "notes",  "alias":"n", "type": str, "required": False, "description": "Note ID to link to the task"},
      ...
      },
      {
        ...
        "subcommands": [
          ...
          },
          {
            ...
            "attributes": [
              {"name": "title", "alias":"t", "type": str, "required": True, "description": "Title of the note"},
              {"name": "category", "alias":"c", "type": str, "required": False, "description": "Category associated with the note"},
          ...
          },
          {
            ...
            "attributes": [
              ...
              {"name": "linked_notes", "alias":"ln","type": str, "required": False, "description": "Updated list of linked note IDs"},
              {"name": "linked_tasks","alias":"lt", "type": str, "required": False, "description": "Updated list of task IDs this note links to"}
            ]
          },
          {
            "subcommand": "delete",
